...
// Schema that conditionally requires branch_id
const schema = z.object({
  ...
  // branch_id required for admin_branch and employee, not for web_admin
  if (d.role !== "web_admin") {
    return d.branch_id && d.branch_id.length > 0;
  }
  return true;
}, {
        ...
        <div className="max-w-sm w-full text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Link verifikasi telah dikirim ke email Anda. Klik link tersebut, lalu tunggu persetujuan admin untuk mengaktifkan akun.
            </p>
          </div>
  ...
  return (
    <div className="auth-page min-h-screen flex bg-background">
      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute bottom-1/4 left-8 right-8 space-y-5">
          <div className="space-y-2">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-sm space-y-7">
            <div className="space-y-1">
              <h1 className="text-2xl font-bold tracking-tight text-foreground">Daftar Akun Admin</h1>
              <p className="text-sm text-muted-foreground">Pilih role Anda, lalu isi data untuk mendaftar</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              {/* Branch — only shown for admin_branch & employee */}
              {needsBranch && (
                <div className="space-y-1.5">
                  <Label className="text-xs font-semibold uppercase tracking-widest text-muted-foreground">
                    Cabang
